...
internal static class GeneratedCodeUtilities
{
    ...
    public static bool BeginsWithAutoGeneratedComment(SyntaxNode root)
    {
        ...
        foreach (var trivia in root.GetLeadingTrivia())
        {
            ...
            {
                if (text.Contains(autoGenerated, StringComparison.Ordinal))
                    return true;
            }
        }
    ...
    private static bool IsComment(SyntaxTrivia trivia) => trivia.RawSyntaxKind() is SyntaxKind.SingleLineCommentTrivia or SyntaxKind.MultiLineCommentTrivia;
}