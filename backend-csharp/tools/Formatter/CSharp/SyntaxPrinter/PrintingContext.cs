...
internal sealed class PrintingContext
{
    ...
    {
        var number = groupNumberByValue.GetValueOrDefault(value, 0) + 1;
        groupNumberByValue[value] = number;
    ...
    {
        State.SkipNextLeadingTrivia = true;
        return this;
    }

    internal sealed class PrintingContextOptions
    {
    ...
    internal sealed class PrintingContextState
    {
