...
{
    public static bool EqualsIgnoreCase(this string value, string otherValue) => string.Equals(value, otherValue, StringComparison.OrdinalIgnoreCase);

    public static bool StartsWithIgnoreCase(this string value, string otherValue) => value.StartsWith(otherValue, StringComparison.OrdinalIgnoreCase);

    public static bool EndsWithIgnoreCase(this string value, string otherValue) => value.EndsWith(otherValue, StringComparison.OrdinalIgnoreCase);
